...
source("../R/Functions cSTM_time_indep.R")
...
The following sections include R code snippets. All the code is stored as a GitHub repository and can be accessed from  https://github.com/DARTH-git/cohort-modeling-tutorial-intro. The R code below describes the initialization of the input parameters.
