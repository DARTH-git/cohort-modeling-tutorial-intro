...
\DocumentationTok{\#\# Constant transition probability of becoming Sick when Healthy conditional on surviving }
...
\DocumentationTok{\#\# Constant transition probability of becoming Healthy when Sick conditional on surviving }
\CommentTok{\# transform rate to probability and scale by the cycle length}
...
\DocumentationTok{\#\# Constant transition probability of becoming Sicker when Sick conditional on surviving }
\CommentTok{\# transform rate to probability and scale by the cycle length}
