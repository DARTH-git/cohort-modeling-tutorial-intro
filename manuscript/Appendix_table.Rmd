...
|              | Data frame to store expected costs and effects for each strategy from the PSA    | `df_out_ce_psa`  | table          |     |    numeric       |
|              | Data frame to store incremental cost-effectiveness ratios (ICERs) from the PSA    | `df_cea_psa`  | table          |     |    numeric       |
